...
#Crear Una LLamada A La API Para 0btener Las Historias.
...
#Obtener Un Proceso Para La información Sobre Cada Publicación.
...
for submission_id in submission_ids[:10]:
    ...
    try:
        ...
        submission_dict = {
            ...
            'author': response_dict.get('by', 'N/A')
        }
        submission_dicts.append(submission_dict)
    except KeyError:
        print(f"Error al procesar la publicación: {submission_id}")

#Obtener La Ordenar De Los Artículos Por Número De Comentarios.
submission_dicts = sorted(submission_dicts, key=itemgetter('comments'), reverse=True)

#Crear La listas Para Obtener el gráfico.
...
# Obtener Los Resultados De La Grafica.
fig.show()