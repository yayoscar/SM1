...
#Aqui amigos configutamos renderer para Visual Studio.
pio.renderers.default='browser'

#seguidamente definimos una función para manejar los reintentos.
...
# aca una llamada a la API para obtener las historias principales.
...
#por ende necesitamos procesar información sobre cada publicación.
submission_ids=response.json()
submission_dicts=[]
for submission_id in submission_ids[:10]:  #limitamos a las 10 discusiones más activas
...
#aqui es por necesidad que ordenamos los artículos por número de comentarios.
submission_dicts=sorted(submission_dicts, key=itemgetter('comments'), reverse=True)

#entonces aca creamos listas para el gráfico.
...
#para daor mayor realze es necesario crear visualización.
