...
#first we need configuarar renderer para Visual Studio.
pio.renderers.default='browser'

#second una función para manejar los reintentos.
...
#third reazalimos una llamada a la API para obtener las historias principales.
...
#then procesar información sobre cada publicación.
...
#then los artículos por número de comentarios.
submission_dicts=sorted(submission_dicts, key=itemgetter('comments'), reverse=True)

#after listas para el gráfico.
...
#finally we need to show gráfico
fig.show()
