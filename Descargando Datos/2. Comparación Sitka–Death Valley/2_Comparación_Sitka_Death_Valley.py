...
nombre_archivo_0='SM1/Descargando Datos/data/sitka_weather_2021_simple.csv'
nombre_archivo_1='SM1/Descargando Datos/data/death_valley_2021_simple.csv'
...
fig,ax=plt.subplots()
ax.plot(fechas,tem_alta_sitka,c='red',alpha=0.5)
ax.plot(fechas,temp_baja_sitka,c='red',alpha=0.5)
ax.plot(fechas_d,tem_alta_death,c='blue',alpha=0.5)
ax.plot(fechas_d,tem_baja_death,c='blue',alpha=0.5)
