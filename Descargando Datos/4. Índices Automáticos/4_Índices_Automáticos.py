...
nombre_archivo_1='Descargando Datos/data0/sitka_weather_2021_simple.csv'
...
ax.plot(fechas, altas, c='orange', alpha=0.5)
ax.plot(fechas, bajas, c='yellow', alpha=0.5)
plt.fill_between(fechas, altas, bajas, facecolor='blue', alpha=0.1)

# Formatear gráfico
#condicionales para los del death
if nombre_archivo.endswith('death_valley_2021_simple.csv'):
    titulo_death = f'Temperaturas máximas y mínimas año 2021\nDeath Valley, CA'
...
#condicionales para los del sitka
if nombre_archivo_1.endswith('sitka_weather_2021_simple.csv'):
    titulo_sitka = f'Temperaturas máximas y mínimas año 2021\nSitka, AK,'
elif nombre_archivo_1.endswith('death_valley_2021_simple.csv'):
    titulo_sitka = f'Temperaturas máximas y mínimas año 2021\nDeath Valley, CA'
else:
    nombre_lugar_2 = nombre_archivo_1.split('/')[-1].split('_')[0].title()
    titulo_sitka = f'Temperaturas máximas y mínimas del 2021\n{nombre_lugar_2}'

plt.title(titulo_death, fontsize=16)
plt.title(titulo_sitka, fontsize=16)
