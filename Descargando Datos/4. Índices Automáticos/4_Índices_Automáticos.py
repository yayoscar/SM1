...
nombre_archivo_1='Descargando Datos/data/sitka_weather_2021_simple.csv'
...
ax.plot(fechas, altas, c='green', alpha=0.5)
ax.plot(fechas, bajas, c='red', alpha=0.5)
plt.fill_between(fechas, altas, bajas, facecolor='green', alpha=0.1)
