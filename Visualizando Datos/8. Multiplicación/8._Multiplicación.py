"""Cuando lanzas dos dados, generalmente sumas los dos números para obtener el resultado. 
Crea una visualización que muestre lo que sucede si multiplicas estos números en su lugar."""
...
configuracion=Layout(title='Resultados del lanzamiento de la multiplicacion de la suma de dos dados de 6 caras',
