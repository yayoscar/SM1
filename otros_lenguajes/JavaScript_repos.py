...
title = 'Proyectos de JavaScript con más estrellas en GitHub'
...
yellow_gradient = [
    [0.0, "lightyellow"],  # Amarillo claro
    [0.5, "gold"],         # Dorado (intermedio)
    [1.0, "darkorange"]    # Naranja oscuro (más intenso)
]
